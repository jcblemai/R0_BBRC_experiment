...
- **Test and Isolate (35-30)**, which assumes that current measures are replaced from May 1 on by a test and isolation protocol, where the infectious period is shortened by 35% for 30% of cases infected. This protocol is accompanied by measures that reduce the $R_0$ to 70% of the baseline, early epidemic level of transmissibility.

- **Test and Isolate (50-60)**, which assumes that current measures are replaced from May 1 on by a test and isolation protocol, where the infectious period is shortened by 50% for 60% of cases infected. This protocol is accompanied by measures that reduce the $R_0$ to 70% of the baseline, early epidemic level of transmissibility.
